...
R code chunks start with <code>&#96;&#96;&#96;{r}</code> and end with <code>&#96;&#96;&#96;</code>, and you insert your R code in between. You can also easily create a new code chunk by clicking on 
```{r, echo=FALSE, out.width = '5%'}
knitr::include_graphics("chunk.png")
```
located at the top of the R Markdown window and select R (the first option in the list).
